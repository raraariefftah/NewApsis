        ...
        <div class="col-md-12">
            ...
            <div class="card card-light">
                <div class="card-header">
                    <h3 class="card-title" style="font-weight: bold; ">A. KETERANGAN SISWA</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <label for="inputLulusan" class="col-md-2 col-form-label" style="left: 25px">a.
                                ...
                                dari</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="inputLulusan" placeholder="Lulusan dari">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="inputOrg" placeholder="Organisasi/Lainnya">
                            </div>
                        </div>
                        ...
                        <label for="inputPindah" class="col-md-2 col-form-label" style="text-indent: -7px">15.
                            Pindahan</label>
                        <div class="form-group row">
                            <label for="inputDariSekolah" class="col-md-2 col-form-label " style="left: 25px" >a. Dari
                                Sekolah</label>
                            <div class="col-md-4">
                        ...
                        <div class="form-group row">
                            <label for="inputAlasanPindah" class="col-md-2 col-form-label" style="left: 25px">b.
                                ...
                                Pindah</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="inputAlasanPindah" placeholder="Alasan Pindah">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="inputKelurahan" class="col-md-2 col-form-label" style="left: 25px">Kelurahan/Desa</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="inputKelurahan" placeholder="Kelurahan/Desa">
                            </div>
                        ...
                        <div class="form-group row">
                            <label for="inputKcm" class="col-md-2 col-form-label" style="left: 25px">Kecamatan</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="inputKcm" placeholder="Kecamatan">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="inputKota" class="col-md-2 col-form-label" style="left: 25px">Kab/Kota</label>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="inputProvinsi" placeholder="SUMATERA UTARA"
                                    disabled="disabled">
                            </div>
                        </div>
                        {{-- 18 --}}
                    ...
                    <div class="card-footer">
                        <a href="/tata_usaha/dashboard" class="btn btn-danger mr-2">Kembali</a>
                        <a href="/hal_pendaftaran/keterangan_ortu" class="btn btn-success">Selanjutnya</a>
                    </div>
                    <!-- /.card-footer -->
                </form>
            </div>
