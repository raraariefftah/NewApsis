...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Edit Keterangan Orang Tua</h1>
            </div>
        </div>
    </div>
    <!-- /.container-fluid -->
                    ...
                    <form class="form-horizontal">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" id="inputTempatAyah"
                                        placeholder="Tempat Lahir">
                                </div>
                                <label for="inputTLAyah" class="col-md-2 col-form-label"> Tanggal Lahir</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" id="inputKwnAyah"
                                        placeholder="Kewarganegaraan">
                                </div>
                                <label for="inputSukuAyah" class="col-md-2 col-form-label">Suku</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group row">
                                ...
                                <div class=" col-md-4">
                                    <input type="text" class="form-control" id="inpuPekerjaanAyah"
                            ...
                            {{-- 9 --}}
                            <div class="form-group row">
                                <label for="inputTelpRumahAyah" class="col-md-2 col-form-label">9. No. Telepon
                                    Rumah</label>
                                <div class=" col-md-4">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" id="inputTempatIbu"
                                        placeholder="Tempat Lahir">
                                </div>
                                <label for="inputTLIbu" class="col-md-2 col-form-label"> Tanggal Lahir</label>
                                <div class="col-md-4">
                                    <div class="input-group">
                                        <input type="text" class="form-control" data-inputmask-alias="datetime"
                                            data-inputmask-inputformat="dd/mm/yyyy" data-mask placeholder="dd/mm/yyyy"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="text" class="form-control" id="inputKwnIbu"
                                        placeholder="Kewarganegaraan">
                                </div>
                                <label for="inputSukuIbu" class="col-md-2 col-form-label">Suku</label>
                                <div class="col-md-4">
                            ...
                            <div class="form-group row">
                                ...
                                <div class=" col-md-4">
                                    <input type="text" class="form-control" id="inpuPekerjaanIbu"
                                        placeholder="Pekerjaan">
                                </div>
                            </div>
                            ...
                            {{-- 18 --}}
                            <div class="form-group row">
                                <label for="inputTelpRumahIbu" class="col-md-2 col-form-label">18. No. Telepon
                                    Rumah</label>
                                <div class=" col-md-4">
                                    <input type="text" class="form-control" id="inputTelpRumah"
                                        placeholder="No. Telepon Rumah">
